...
// 		}
	...
	public static function getThemeUrl($resource = null)
	{
		...
		if($resource === null)
		{
			return PZ::getWebUrl() . '/static/themes/' . $currentTheme . '/';
		}
		return PZ::getWebUrl() . '/static/themes/' . $currentTheme . '/' . $resource;
	}
	...
	public static function getAttachUrl($url, $echo = true)
	{
		if($echo)
		{
			echo PZ::getWebUrl() . '/data/attachment/' . $url;
		}
		return PZ::getWebUrl() . '/data/attachment/' . $url;
	}

	public static function getCachedValue($cache, $id = null, $defaultValue = null)
	{
		$cacheItem = PZ::getAppParam($cache);
		if($cacheItem === null)
		{
	...
	{
		$cached = PZ::getAppParam('cachedConfigs');
		if($id!==null)
		{
			return $cached[$id];
		}
	...
	{
		$cached = PZ::getAppParam('cachedVariables');
		if($id!==null)
		{
			return $cached[$id];
		}
	...
	{
		$cached = PZ::getAppParam('cachedDicts');
