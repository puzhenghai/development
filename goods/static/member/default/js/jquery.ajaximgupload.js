jQuery.extend({
	...
	createUploadForm : function(id, elementId, data) {
		// create form
	...
	ajaxFileUpload : function(s) {
		...
		var form = jQuery.createUploadForm(id, s.elementId,
	...
	handleError : function(s, sxhr, status, e) {
		// If a local callback was specified, fire it
		if (s.error) {
			s.error.call(s.context || s, sxhr, status, e);
		}
